...
#define LCD_CS D3 // Chip Select goes to Analog 3
#define LCD_CD D2 // Command/Data goes to Analog 2
#define LCD_WR D1 // LCD Write goes to Analog 1
#define LCD_RD D0 // LCD Read goes to Analog 0

#define LCD_RESET D4 // Can alternately just connect to Arduino's reset pin
